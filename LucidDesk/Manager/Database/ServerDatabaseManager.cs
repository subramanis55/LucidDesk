...
namespace LucidDesk.Manager.Database
{
    ...
    //        {
    //            string connectionString = $"Server={SettingsManager.Settings.ServerAddress};Port={SettingsManager.Settings.ServerPort};Uid={SettingsManager.Settings.ServerUserName};Pwd={SettingsManager.Settings.ServerPassword};Database={DefalutDatabaseName};";
    ...
    //        try
    //        {
    //            string connectionString = $"Server={SettingsManager.Settings.ServerAddress};Port={SettingsManager.Settings.ServerPort};Uid={SettingsManager.Settings.ServerUserName};Pwd={SettingsManager.Settings.ServerPassword};Database={SettingsManager.Settings.ServerDatabase};"; 
    //            mySqlConnection.ConnectionString = connectionString;
    //            mySqlConnection.Open();
    //            mySqlCommand.Connection = mySqlConnection;
    //            return true;
